        ...
        >
          ...
          <form onSubmit={handleEmailLogin} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  type="button"
                  className="text-xs text-muted-foreground hover:text-foreground transition-colors opacity-50 cursor-not-allowed"
                  disabled
            ...
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 border-border rounded bg-secondary focus:ring-2 focus:ring-ring disabled:opacity-50"
                disabled={loading}
              />
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              ...
              disabled
              title="Facebook login not available"
            >
